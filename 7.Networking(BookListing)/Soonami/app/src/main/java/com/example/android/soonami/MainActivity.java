    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Failed to perform request", e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (statusCode == 200) {
                    ...
                    Log.e(LOG_TAG, "Receive unsuccessful status code: " + statusCode);
                }
            } catch (IOException e) {
                Log.e(LOG_TAG, "Problem retrieving earthquake JSON response", e);
            } finally {
